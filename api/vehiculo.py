                ...
                with sync_playwright() as p:
                    ...
                    try:
                        radio_button_pendiente = page.wait_for_selector(
                            '//input[@type="radio" and @value="P"]', timeout=15000
                        )
                        ...
                        if len(elements) > 0:
                            ...
                            radio_button = page.wait_for_selector(
                                '//input[@type="radio" and @value="G"]', timeout=15000
                            )
                            radio_button.click()
                            time.sleep(2)
                            elements = page.query_selector_all(
                        ...
                        if placa:
                            ...
                            response = requests.get(url_placa, timeout=15)
                            ...
                            if response.status_code == 200:
                                ...
                                data_list = [
                                    td.get_text(strip=True) for td in td_elements
                                ]
